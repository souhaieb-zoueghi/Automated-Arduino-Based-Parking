...
void loop() {
  ...
  switch(parkingStatus){
        ...
        case VERIFY_ENTRANCE :
          ...
          if (getDistance() <= MAXIMUM_DISTANCE_TO_OPEN_BARRIER) // replace the value (9) by a significant MACRO, see the suggestion below ...
        ...
        case VERIFY_PARKING_STATUS :
          ...
          if (currentCarsNumberIn >= PARKING_MAX_CAPACITY) // replace the value (7) by a significant MACRO, e.g. #define MAX_PARKING_CAPACITY 7
